...
_defineProperty(Input, "touch", false);

_defineProperty(Input, "touchdown", false);

_defineProperty(Input, "touchup", false);

_defineProperty(Input, "frametouchdown", false);

_defineProperty(Input, "frametouchup", false);
